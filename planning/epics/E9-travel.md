...
- [ ] Per-item weight + volume — **reuse the [E11](./E11-laundry-forecasting.md) US-11.3 weight/volume model** (`utils/itemPhysical.ts`), editable override
...
## Dependencies
- **Weight/volume model owned by [E11](./E11-laundry-forecasting.md) (US-11.3)** — Travel consumes it for suitcase fullness; don't redefine.
