...
export const ZONE_GROUPS: ItemCategory[][] = [["Tops", "Dresses", "Outerwear"], ["Bottoms"], ["Shoes"], ["Accessories"]];

export const OVERLAY_ORDER: ItemCategory[] = ["Bottoms", "Dresses", "Tops", "Shoes", "Accessories", "Outerwear"];

export const DEFAULT_AVATAR = "https://images.unsplash.com/photo-1529139574466-a303027bc541?w=700&h=1050&fit=crop&auto=format&q=80";
