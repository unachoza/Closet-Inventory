        ...
        <div className="jc-header__legend">
          ...
          {PHASES.map((phase) => (
            <div key={phase.id} className="jc-legend-item">
              <span
                className="jc-legend-dot"
                style={{ background: DARK_ACCENTS[phase.id] }}
              />
              {phase.name}
            </div>
          ))}
                ...
                {phase.steps.map((step, si) => (
                  ...
                  >
                    <div className="jc-step-node__title">
                      <span
                        className="jc-step-dot"
                        style={{ background: accent }}
                      />
                      {step.title}
                    </div>
                    <div className="jc-step-node__preview">
                      {previews[si] ?? ""}
                    </div>
          ...
          <div className="jc-modal">
            <div className="jc-modal__header">
              <div className="jc-modal__header-left">
                <div
                  className="jc-modal__phase-label"
                  style={{ color: modalData.accent }}
                >
                  {modalData.phase.name}
                </div>
                <div className="jc-modal__step-title">
                  {modalData.step.title}
                </div>
              </div>
